...
drop if phi <= -0.5
drop if phi >= 0.5
histogram beta, title("Beta coefficient. Urban", color(black)) xtitle ("Beta") graphregion(color(white)) bcolor(maroon)
graph export "C:\Users\beras\OneDrive\Escritorio\Homework3\Output\histogrambetaurban.png", replace
histogram phi, title("Phi coefficient. Urban", color(black)) xtitle ("Phi") graphregion(color(white)) bcolor(navy)
graph export "C:\Users\beras\OneDrive\Escritorio\Homework3\Output\histogramphiurban.png", replace
...
gen hhnumber = _n 
gen group_i = 0
replace group_i = 5 if hhnumber > 487 & hhnumber <= 609
replace group_i = 4 if hhnumber > 365 & hhnumber <= 487
replace group_i = 3 if hhnumber > 244 & hhnumber <= 365
replace group_i = 2 if hhnumber > 122 & hhnumber <= 244
replace group_i = 1 if hhnumber <= 122
...
gen hhnumber = _n 
gen group_beta = 0
replace group_beta = 5 if hhnumber > 609 & hhnumber <= 609
replace group_beta = 4 if hhnumber > 365 & hhnumber <= 487
replace group_beta = 3 if hhnumber > 244 & hhnumber <= 365
replace group_beta = 2 if hhnumber > 122 & hhnumber <= 244
replace group_beta = 1 if hhnumber <= 122
*** Mean and median betas
forvalues i = 1(1)5 {
