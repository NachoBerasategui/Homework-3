...
drop if phi <= -0.5
drop if phi >= 0.5
histogram beta, title("Beta coefficient", color(black)) xtitle ("Beta") graphregion(color(white)) bcolor(maroon)
graph export "C:\Users\beras\OneDrive\Escritorio\Homework3\Output\histogrambeta.png", replace
histogram phi, title("Phi coefficient", color(black)) xtitle ("Phi") graphregion(color(white)) bcolor(navy)
graph export "C:\Users\beras\OneDrive\Escritorio\Homework3\Output\histogramphi.png", replace
...
gen hhnumber = _n 
gen group_i = 0
replace group_i = 5 if hhnumber > 2304 & hhnumber <= 2879
replace group_i = 4 if hhnumber > 1728 & hhnumber <= 2304
replace group_i = 3 if hhnumber > 1152 & hhnumber <= 1728
replace group_i = 2 if hhnumber > 576 & hhnumber <= 1152
replace group_i = 1 if hhnumber <= 576
...
gen hhnumber = _n 
gen group_beta = 0
replace group_beta = 5 if hhnumber > 2304 & hhnumber <= 2879
replace group_beta = 4 if hhnumber > 1728 & hhnumber <= 2304
replace group_beta = 3 if hhnumber > 1152 & hhnumber <= 1728
replace group_beta = 2 if hhnumber > 576 & hhnumber <= 1152
replace group_beta = 1 if hhnumber <= 576
*** Mean and median betas
forvalues i = 1(1)5 {
